		...
		<div class="col-lg-12">
			<div class="card">
				...
				<div class="card-body table-responsive mt-2">
					...
					<?php } ?>
					<button type="button" class="btn btn-primary mb-2 mt-5" data-bs-toggle="modal" data-bs-target="#addModal1" style="color: white">
						New Data
					</button>
						...
						<tbody>
							...
							foreach ($receiving_material as $material) :
								...
								<tr>
									...
									<td>
										<button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#editModal<?= $material['id_box']; ?>">
											<i class="bx bxs-edit" style="color: white;"></i>
										</button>
										<button class="btn btn-danger ms-1" data-bs-toggle="modal" data-bs-target="#deleteModal<?= $material['id_box']; ?>">
			...
			<div class="modal-body">
				<div class="row ps-2">
					<div class="col-6">
						...
						<input type="number" class="form-control" id="reference_number" name="reference_number" onblur="getMaterial()" required>
					</div>
					<div class="col-6">
				...
				<div class="modal-body">
					<div class="row ps-2">
						<div class="col-4">
							...
							<input type="text" class="form-control" id="id" name="id" value="<?= $material['id_box']; ?>" hidden>
						</div>
						<div class="col-4">
	...
	function getMaterial() {
		...
		$.ajax({
			...
			success: function(res) {
				// Isi kolom Material dan UOM dengan data yang diterima dari backend
