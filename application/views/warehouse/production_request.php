                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button type="button" class="btn btn-primary"
                                        onclick="redirectTo('<?= base_url('warehouse/approve_production_plan'); ?>', '<?= $request['Production_plan']; ?>')">Detail</button>
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-sm-6">
                        <input type="text" class="form-control" value="<?= $request['Fg_Desc']; ?>"
                            id="productDescription<?= $request['id']; ?>" name="productDescription"
