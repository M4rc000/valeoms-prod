                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button type="button" class="btn btn-primary" onclick="redirectTo('<?= base_url('warehouse/approve_production_plan'); ?>', '<?= $request['Production_plan']; ?>')"><i class="bx bx-show"></i>  Detail</button>
                                    ...
                                    <button class="btn btn-primary" class="choose-sloc-box" data-bs-toggle="modal" data-bs-target="#detailRejectSlocAndBox<?= $request['Production_plan']; ?>">
        ...
        <div class="modal-content">
            ...
            <div class="row">
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-sm-2">
                        <input type="number" class="form-control" value="<?= $request['Production_plan_qty']; ?>" id="qty"
...
<!-- REJECT MODAL DETAIL-->
<?php foreach ($production_request as $request): ?>
<div class="modal fade" id="detailRejectSlocAndBox<?= $request['Production_plan']; ?>" tabindex="-1" style="display: none;">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
            ...
            if (data.status && data.dt.length > 0) {
                ...
                for (var i = 0; i < dt.length; i++) {
                    ...
                    $('.sloc-select').eq(i).on('change', function() {
                        ...
                        // reset ID Box select
                        $('.id-box-select').eq(selectedIndex).html('<option value="">-- Pilih ID Box --</option>');
                        ...
                        fetchIdBoxOptions(dt[selectedIndex].Id_material, selectedSlocId, selectedIndex);
                    });
...
function printReqReject(production_plan) {
    window.open('<?php echo base_url() . $this->router->fetch_class(); ?>/print_request_reject/' + production_plan, '_blank');
}
