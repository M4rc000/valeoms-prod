...
INSERT INTO `user` (`id`, `name`, `username`, `email`, `password`, `image`, `gender`, `place_of_birth`, `date_of_birth`, `country`, `date_joined`, `is_active`, `token`, `role_id`) VALUES
(1, 'Marco', 'Prime', 'menggunakan392?gmail.com', '$2y$10$DMF.T6mKOkmOUmpuH9mTseHBoOtZj4hX2TVkt4B6DMieiROqdwXQi', 'default.webp', 'Male', 'Bogor', '03-11-2003', 'Indonesia', '2023-11-03 19:30', 1, '', 1),
(2, 'Robby', 'Robbs', 'robbyarsyadani@gmail.com', '$2y$10$DMF.T6mKOkmOUmpuH9mTseHBoOtZj4hX2TVkt4B6DMieiROqdwXQi', 'default.webp', 'Male', '', '', 'Indonesia', '2023-12-01 19:30', 1, '', 1),
(3, 'Hansen', 'Hnsz', 'Hansenhoswari@gmail.com', '$2y$10$DMF.T6mKOkmOUmpuH9mTseHBoOtZj4hX2TVkt4B6DMieiROqdwXQi', 'default.webp', 'Male', '', '', 'Indonesia', '2023-12-05 19:30', 1, '', 1),
(30, 'Antonio', 'Ant', 'marcoantoniomadgaskar@gmail.com', '$2y$10$7RLlg/J/5shCPI54TLwU6eqABEFfgqFlnuJnnRQ5gr/OSU6tBi7rq', 'default.webp', '', '', '', '', '2023-10-01 20:00', 1, '413178', 1),
(43, 'Bimo', 'bim_', 'rrqmarc@gmail.com', '$2y$10$nbTUMLTWc7KAwoVRbVorluKpTwHrXFmlQJ6RC9sf6AHa0yCcKC7n2', 'default.webp', '', '', '', '', '2023-11-30 17:00', 1, '838655', 2),
(45, 'Fiona', 'fio_', 'fiona@gmail.com', '$2y$10$DMF.T6mKOkmOUmpuH9mTseHBoOtZj4hX2TVkt4B6DMieiROqdwXQi', 'fight-1.png', NULL, NULL, NULL, NULL, '2023-12-20 15:00', 1, 'JMyXqIj2oY4lAeOQ0DepU8XnbDVCqg0Z7eKeGSJYJE4=', 1);
...
CREATE TABLE `user_menu` (
  ...
  `crtby` varchar(15) NOT NULL,
  `upddt` varchar(20) NOT NULL,
  `updby` varchar(15) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(1, 'Admin', '17-12-2023 15:48', 'System', '17-12-2023 15:48', 'System'),
(2, 'User', '2023-12-20 15:00', 'System', '2023-12-20 15:00', 'System'),
(3, 'Explore', '2023-12-20 15:00', 'System', '2023-12-20 15:00', 'System');
...
INSERT INTO `user_role` (`id`, `role`, `crtdt`, `crtby`) VALUES
(1, 'Administrator', '2023-12-20 15:00', 'System'),
(2, 'User', '2023-12-20 15:00', 'System');
