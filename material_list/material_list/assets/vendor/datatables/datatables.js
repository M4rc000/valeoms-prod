...
! function (n) {
			...
			return $.factory(t, H) ? $ : this instanceof $ ? V(t).DataTable(H) : (X = void 0 === (H = t), B = (W = this).length, X && (H = {}), this.api = function () {
				...
				if ("table" != this.nodeName.toLowerCase()) Z(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2);
					...
					var g, v, m, b, y, D, x, S = u,
						...
						C = S.aoColumns;
					if (w)
						for (g = 0, v = w.length; g < v; g++) w[g] && w[g].name && (C[g].sName = w[g].name);
					if (T)
	...
	function M(t) {
		...
		if (e.oFeatures.bAutoWidth) {
			...
			r.style.width = A(b), m.remove(), c && (r.style.width = A(c)), !c && !s || e._reszEvt || (V(q).on("resize.DT-" + e.sInstance, $.util.throttle(function () {
				e.bDestroying || M(e)
			})), e._reszEvt = !0)
		}
	...
	function Ct(e) {
		...
		n.oFeatures.bProcessing && (a = V("<div/>", {
			...
			role: "status"
		}).html(n.oLanguage.sProcessing).append("<div><div></div><div></div><div></div><div></div></div>"), v ? a.prependTo(V("div.dt-scroll", n.nTableWrapper)) : a.insertBefore(t), V(t).on("processing.dt.DT", function (t, e, n) {
	...
	function Xt(e) {
		...
		if (e.scrollBarVis !== f && void 0 !== e.scrollBarVis) e.scrollBarVis = f, M(e);
			...
			if (e.scrollBarVis = f, u.children("thead, tfoot").remove(), (f = s.clone().prependTo(u)).find("th, td").removeAttr("tabindex"), f.find("[id]").removeAttr("id"), c && (v = c.clone().prependTo(u)).find("[id]").removeAttr("id"), e.aiDisplay.length)
			...
			}), c && V("th, td", v).each(function () {
				V(this.childNodes).wrapAll('<div class="dt-scroll-sizing">')
			});
			var s = Math.floor(u.height()) > r.clientHeight || "scroll" == o.css("overflow-y"),
				f = "padding" + (d.bScrollbarLeft ? "Left" : "Right"),
				v = u.outerWidth();
			a.css("width", A(v)), n.css("width", A(v)).css(f, s ? t + "px" : "0px"), c && (l.css("width", A(v)), i.css("width", A(v)).css(f, s ? t + "px" : "0px")), u.children("colgroup").prependTo(u), o.trigger("scroll"), !e.bSorted && !e.bFiltered || e._drawHold || (r.scrollTop = 0)
		}
	}
	...
	function zt(t, e, n) {
		...
		for (B(t), void 0 !== e ? (l = t.aoColumns[e], c = [{
			...
			for (var D = $.ext.type.order[b.sType + "-pre"], x = v.aoData, S = 0; S < x.length; S++) x[S] && ((p = x[S])._aSortData || (p._aSortData = []), p._aSortData[m] && !y || (g = y ? h[S] : G(v, S, m, "sort"), p._aSortData[m] = D ? D(g, v) : g))
		}
	...
	var he = function (t, e) {
		...
		pe = (e("rows()", function (n, a) {
			...
			return void 0 === t ? n.length && this.length && this[0].length ? n[0].aoData[this[0]]._aData : void 0 : ((e = n[0].aoData[this[0]])._aData = t, Array.isArray(t) && e.nTr && e.nTr.id && v(n[0].rowId)(t, e.nTr.id), gt(n[0], this[0], "data"), this)
		}), e("row().node()", function () {
			var t = this.context;
		...
		ye = (e(be, function (t, e) {
			var n = this.context;
			return void 0 === t ? n.length && this.length && n[0].aoData[this[0]] ? n[0].aoData[this[0]]._details : void 0 : (!0 === t ? this.child.show() : !1 === t ? ve(this) : n.length && this.length && se(n[0], n[0].aoData[this[0]], t, e), this)
		...
		be = (e("columns()", function (n, a) {
			...
			var a, r, o, i, l, s, e;
			return V.isPlainObject(g) && (void 0 === g.row ? (v = g, g = null) : (v = t, t = null)), V.isPlainObject(t) && (v = t, t = null), null == t ? this.iterator("table", function (t) {
				return a = t, t = g, e = ie(v), d = a.aoData, f = he(a, e), n = b(m(d, f, "anCells")), h = V(E([], n)), p = a.aoColumns.length, oe("cell", t, function (t) {
				...
				return n
			}, 1), e = v && v.selected ? this.cells(e, v) : e, V.extend(e.selector, {
				cols: t,
				rows: g,
				opts: v
			}), e)
		...
		}), $.version = "2.0.7", $.settings = [], $.models = {}, $.models.oSearch = {
			caseInsensitive: !0,
			search: "",
			regex: !1,
			smart: !0,
		...
		function n() {
			! function t(e, n, a) {
				...
				for (var p = 0; p < f.length; p++) {
					...
					}), "number" != typeof g && V(m.clicker).addClass(g), Qt(m.clicker, {
						action: g
					}, function (t) {
