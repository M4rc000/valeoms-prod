						...
						<tbody>
							...
							foreach ($list_storage as $storage) :
								...
								<tr>
									...
									<td>
										<?php echo $storage['total_qty']; ?>
									</td>
									<td>
                                    <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#detailModal1<?= $storage['product_id']; ?>" onclick="getDetailStorage('<?= $storage['product_id']; ?>')">
